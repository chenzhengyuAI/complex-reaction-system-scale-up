...
# y = pd.read_csv(file_path_y, header=None, nrows=1000)
...
#
# # 保存训练集到CSV文件
# df_input1_train.to_csv('C:/chenzhengyu/data driven model/data/input1_train_pilot.csv', index=False)
# df_input2_train.to_csv('C:/chenzhengyu/data driven model/data/input2_train_pilot.csv', index=False)
# df_targets_train.to_csv('C:/chenzhengyu/data driven model/data/targets_train_pilot.csv', index=False)
#
# # 保存测试集到CSV文件
# df_input1_test.to_csv('C:/chenzhengyu/data driven model/data/input1_test_pilot.csv', index=False)
# df_input2_test.to_csv('C:/chenzhengyu/data driven model/data/input2_test_pilot.csv', index=False)
# df_targets_test.to_csv('C:/chenzhengyu/data driven model/data/targets_test_pilot.csv', index=False)

input1_train, targets_train, scaler = preprocess_data(input1_train, targets_train)
joblib.dump(scaler, 'C:/chenzhengyu/data driven model/code/scaler_input1_pilot_60.pkl')
input2_train, targets_train, scaler = preprocess_data(input2_train, targets_train)
joblib.dump(scaler, 'C:/chenzhengyu/data driven model/code/scaler_input2_pilot_60.pkl')
...
model_paths = [
    'C:/chenzhengyu/data driven model/code/model_checkpoint_pilot_net1_prop_60.pth',
    'C:/chenzhengyu/data driven model/code/model_checkpoint_pilot_net2_prop_60.pth',
    'C:/chenzhengyu/data driven model/code/model_checkpoint_pilot_agg_net_prop_60.pth'
]
